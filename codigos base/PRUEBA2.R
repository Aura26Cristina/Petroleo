...
Filt_Mun<-function(x,y){
  
  x<- Petroleo %>% filter(Municipio == y)}
  
vectorMunicipios<-unique(Petroleo[,"Municipio"])
vectorMunicipios1<-c()

for(j in 1:length(vectorMunicipios)){
  vectorMunicipios[j]<-Filt_Mun(vectorMunicipios[j],as.character(vectorMunicipios[j]))
    }
...
P.ACACIAS <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.AGUACHICA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.AGUAZUL <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.AIPE <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.ALVARADO <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.ARAUCA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.ARAUQUITA <-Filt_Mun(P.ACACIAS,"ACACIAS")
P.ARIGUANI <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.BARAYA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.BARRANCA_DE_UPIA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.BARRANCABERMEJA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.CABUYARO <-Filt_Mun(P.ACACIAS,"ACACIAS")
P.CANTAGALLO <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.CASTILLA_NUEVA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.CHAPARRAL <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.CICUCO <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.CIMITARRA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.CORRALES <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.CUCUTA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.ESPINAL <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.GARZON <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.GUADUAS <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.GUAMAL <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.GUAMO <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.IPIALES <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.MANI <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.MELGAR <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.MOCOA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.MONTERREY <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.MUNICIPIO_NN <-Filt_Mun(P.ACACIAS,"ACACIAS")
P.NEIVA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.ORITO <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.OROCUE <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.ORTEGA <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.OVEJAS <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.PAICOL <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.PALERMO <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.PAZ_DE_ARIPORO <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.PIAMONTE <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.PIEDRAS <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.PLATO <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.PORE <- Filt_Mun(P.ACACIAS,"ACACIAS")
P.PRADO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUEBLO_NUEVO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUERTO_ASIS <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUERTO_BOYACA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUERTO_CAICEDO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUERTO_GAITAN <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUERTO_LOPEZ <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUERTO_NARE <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUERTO_TRIUNFO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PUERTO_WILCHES <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PULI <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.PURIFICACION <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.RIO_DE_ORO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.RIONEGRO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SABANA_DE_TORRES <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SABANALARGA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SAN_ALBERTO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SAN_LUIS <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SAN_LUIS_GACENO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SAN_LUIS_DE_PALENQUE <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SAN_MARTIN <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SAN_MIGUEL <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SAN_PEDRO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SAN_VICCENTE_DE_CHUCURI <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SANTA_ANA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SARDINATA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.SIMACOTA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.TALIGUA_NUEVO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.TAME<- Filt_Mun(P.ACACIAS,"ACACIAS")

P.TAURAMENA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.TESALIA <-Filt_Mun(P.ACACIAS,"ACACIAS")

P.TIBU <-Filt_Mun(P.ACACIAS,"ACACIAS")

P.TOPAGA <-Filt_Mun(P.ACACIAS,"ACACIAS")

P.TRINIDAD <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.VALLE_DE_GUAMEZ <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.VILLA_NUEVA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.VILLA_GARZON <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.VILLAVICENCIO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.VILLAVIEJA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.YONDO <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.YAGUARA <- Filt_Mun(P.ACACIAS,"ACACIAS")

P.YOPAL <- Filt_Mun(P.ACACIAS,"ACACIAS")
